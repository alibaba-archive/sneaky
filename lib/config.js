...
(function() {
  ...
  Config = (function() {
    function Config(options) {
      ...
      this.configFile = options.configFile || ("" + process.env.HOME + "/.sneakyrc");
    }
    ...
    Config.prototype._stepUser = function(project, callback) {
      var _addUser,
        _this = this;
      if (callback == null) {
        callback = function() {};
      ...
      _addUser = function() {
        ...
        user = project.user || _this.configs.user;
        if (user != null) {
          options["default"] = user;
        }
        return read(options, function(err, user) {
    ...
    Config.prototype._stepServers = function(project, callback) {
      var _addServer,
        _this = this;
      if (callback == null) {
        callback = function() {};
      ...
      _addServer = function() {
        var defaultServers, options;
        options = {
          prompt: "do you want specific servers for " + project.name + "?"
        };
        defaultServers = project.servers || _this.configs.servers;
        if (defaultServers != null) {
          options["default"] = defaultServers;
        }
        return read(options, function(err, servers) {
    ...
    Config.prototype._stepDest = function(project, callback) {
      var destination, k, options, projects, _project;
      if (callback == null) {
        callback = function() {};
      }
      ...
      return read(options, function(err, destination) {
        if (destination != null) {
    ...
    */
    ...
    Config.prototype["delete"] = function(callback) {
      ...
      projects = (this.configs != null).projects;
    ...
    Config.prototype.edit = function(callback) {
      ...
      return read({
        ...
        return async.eachSeries(['_stepUser', '_stepServers', '_stepSource', '_stepVersion', '_stepDest', '_stepExcludes', '_stepBefore', '_stepAfter'], (function(func, next) {
