...
(function() {
  var Logger, Moment, after, archive, async, autoTag, before, deploy, exec, execCmd, fs, getServers, jsYaml, local, main, path, quit, rsync, spawn, spawnCmd,
  ...
  archive = function(project, callback) {
    ...
    gitCmd = ("rm -rf " + (path.join(local.dir, prefix)) + "; git archive " + (project.version || 'HEAD') + " --prefix=" + prefix + " ") + ("--remote=" + project.source + " --format=tar | tar -xf - -C " + local.dir);
