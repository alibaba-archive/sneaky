...
(function() {
  ...
  parse = function(project, options, dest) {
    ...
    if ((user != null) && (host != null)) {
      cmd = ["rsync -a --timeout=15 --delete-after --ignore-errors --force", "-e \"ssh -p " + port + "\"", parser.includes(project), parser.excludes(project), "" + sourceDir + "/", "" + user + "@" + host + ":" + destination].join(' ');
    } else {
