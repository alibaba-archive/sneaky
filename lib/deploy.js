...
(function() {
  var Logger, Moment, after, archive, async, before, deploy, exec, fs, getServers, jsYaml, local, main, quit, rsync, runCmd;
  ...
  main = function(options, callback) {
    ...
    while (!((local.configs.projects != null) && local.configs.projects.length > 0)) {
